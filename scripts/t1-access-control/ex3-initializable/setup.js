...
(async () => {
    try {
        ...
        contractName = 'MyProxyWalletImplementation' // Change this for other contract
        ...
        console.log('MyProxyImplementation deployed at ', newContractInstance.options.address)
        ...
        contractName = 'MyProxyWallet' // Change this for other contract
        ...
        console.log('MyProxyWallet deployed at ', newContractInstance.options.address)
