...
(async () => {
    try {
        ...
        // Note that the script needs the ABI which is generated from the compilation artifact.
        // Make sure contract is compiled and artifacts are generated
        artifactsPath = `browser/contracts/t1-access-control/ex4-dos/artifacts/${contractName}.json` // Change this for different path
...
// -------->>> We initialize proxy implementation

        await contractImpl.methods.initialize("0x0000000000000000000000000000000000000000").send({from: accounts[0]})
