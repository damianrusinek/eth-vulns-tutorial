...
(async () => {
    try {
        ...
        contractName = 'ERC20_Visibility' // Change this for other contract
    
        // Note that the script needs the ABI which is generated from the compilation artifact.
        // Make sure contract is compiled and artifacts are generated
        artifactsPath = `browser/github/damianrusinek/eth-vulns-tutorial/contracts/t1-access-control/ex1-visibility/artifacts/${contractName}.json` // Change this for different path
        ...
        console.log('MyVulnerableToken deployed at ', newContractInstance.options.address)
